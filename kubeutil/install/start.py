    ...
    for n in allnodes:
        ...
        if cmd == 'export' :
            ...
            if allnodes.index(n) + 1 == len(allnodes):
                for e in etcds:
                    backupcmd = 'ssh ' + acc + '@' + e + ' sudo /opt/bin/etcdctl \
                                backup --data-dir ' + etcddatapath + ' --backup-dir ' + etcdbackuppath
            ...
            if node_role == 'master':
                ...
                res, checkversion = deploy.diff_docker_version(n, docker_ex_version, docker_version, acc, passwd)
            ...
            if res == True :
                ...
                time.sleep(2)
                version_flag, version = deploy.diff_docker_version(n, docker_ex_version, docker_version, acc, passwd)
